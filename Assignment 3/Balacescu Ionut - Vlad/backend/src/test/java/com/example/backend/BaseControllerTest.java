...
public abstract class BaseControllerTest {
    ...
    protected ResultActions performDeleteWIth2PathVariable(String path, Object pathVariable1,Object pathVariable2) throws Exception {
        return mockMvc.perform(jsonType(delete(path, pathVariable1,pathVariable2)));
    }
