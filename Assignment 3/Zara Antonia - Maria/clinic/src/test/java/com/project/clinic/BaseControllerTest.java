...
public abstract class BaseControllerTest {
    ...
    protected ResultActions performRequestWithPathVariables(String path,Object... pathVariables) throws Exception {
        return mockMvc.perform(request(HttpMethod.GET, path));
    }

    protected ResultActions performGetWithPathVariables(String path,Object... pathVariables) throws Exception {
