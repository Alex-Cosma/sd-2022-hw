...
public class TestCreationFactory {
    ...
    public static <T> List<T> listOf(Class cls, Object... parameters) {
        ...
        if (cls.equals(UserListDTO.class)) {
            ...
            supplier = TestCreationFactory::newSong;
        } else if (cls.equals(SongDTO.class)) {
            supplier = TestCreationFactory::newSongDTO;
        } else if (cls.equals(Album.class)) {
            supplier = TestCreationFactory::newAlbum;
        } else if (cls.equals(Album.class)) {
            supplier = TestCreationFactory::newRecord;
        }else if (cls.equals(Album.class)) {
    ...
    public static SongDTO newSongDTO() {
