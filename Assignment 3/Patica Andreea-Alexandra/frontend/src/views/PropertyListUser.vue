...
<!--      this.properties = await api.properties.getPropertiesByOwner(store.state.user);     //TODO-->
...
export default {
  ...
  methods: {
    ...
    async refreshList() {
      ...
      this.dialogVisible = false;
      this.selectedProperty = {};
      this.properties = await api.properties.getPropertiesByOwner(store.state.user);
      console.log("bbbbbbbbbbbbbbb");
    },
  },
  created() {
