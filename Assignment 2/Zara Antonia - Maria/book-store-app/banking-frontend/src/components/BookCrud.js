...
export default function BookCrud() {
    ...
    const rows = [
        createData('Title', bookResponse.title),
        createData('Author', bookResponse.author),
        createData('Genre', bookResponse.genre),
        createData('Quantity', bookResponse.quantity),
        createData('Price', bookResponse.price),
    ];
